...
namespace Klinkby.OAuth2
{
    public class GoogleOAuth : OAuthBase
    {
        ...
        private static readonly DataContractJsonSerializer TokenResponseSerializer =
            new DataContractJsonSerializer(typeof (TokenResponse));

        private static readonly DataContractJsonSerializer UserSerializer =
            new DataContractJsonSerializer(typeof (GoogleUser));
        ...
        public GoogleOAuth(string appId, string appSecret, string scope)
        {
            _appId = appId;
        ...
        public override string GetToken(string returnUrl)
        {
            ...
            string graphTokenPost = string.Format(CultureInfo.InvariantCulture, GraphTokenPostFormat,
                Context.Server.UrlEncode(code), _appId, _appSecret,
