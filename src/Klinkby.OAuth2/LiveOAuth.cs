...
public class LiveOAuth : OAuthBase
{
    ...
    private static readonly DataContractJsonSerializer UserSerializer = new(typeof(LiveUser));

    private static readonly DataContractJsonSerializer ErrorSerializer = new(typeof(ErrorResponse));

    private static readonly DataContractJsonSerializer TokenSerializer = new(typeof(TokenResponse));

    private static readonly DataContractJsonSerializer GraphErrorSerializer = new(typeof(GraphErrorResponse));

    private readonly string _appId;
    private readonly string _appSecret;
    private readonly string _scope;

    public LiveOAuth(string appId, string appSecret, string scope, Uri requestUrl)
        : base(requestUrl)
    {
        _appId = appId;
    ...
    public override UserProfile GetUserProfile(string token)
    {
        ...
        {
            throw new OAuthException(GetGraphErrorMessage(e), e);
        }
